...
$pdo = new PDO('mysql:host=localhost;dbname=tp_netflixx_nom_prenom', 'root', '');
...
<body>
    ...
    <header class="header">
        <img src="./images/netnet.jpg" alt="Logo Netflix" class="header-image">
    </header>
        ...
        <div class="film-list">
            <?php foreach ($films as $film): ?>
                <div class="film-item">
                    ...
                    <a href="Details.php?id=<?= $film['id'] ?>">Consulter ce film</a>
                </div>
            <?php endforeach; ?>
        </div>
    </main>
